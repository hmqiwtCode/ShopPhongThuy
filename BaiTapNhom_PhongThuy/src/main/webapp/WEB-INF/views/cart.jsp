...
<body>
					...
					<table class="table table-hover" id="tblCartItem">
						...
						<tr>
							...
							<td colspan="2"><i class="fa fa-money" aria-hidden="true"></i>
								Tổng tiền:</td>
							<td colspan="2" id="tongtien"><fmt:formatNumber type="number" pattern="###,###" value="${tongTien}" /></td>
						</tr>
					</table>
	...
	<script
		...
		crossorigin="anonymous"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/ThaoTacSanPham.js"></script>
